...
<table width="250" border="1">
    ...
    <tr>
        ...
        <td>修正を展開済み<br>※ 本修正は Yu Gothic UI フォントのバージョン 1.95 以降にて展開されております</td>
        <td></td>
        <td>// シナリオ<br>- "・" と "「" を入力した場合<br>- 括弧類("「" "」" , "『" "』",  "【" "】") を続けて入力した場合<br> - "「" や "」" を連続して入力した場合。</td>
    </tr>
    <tr>
        <td>チャットで 「引用して返信」 を用いると文字入力ができない状況が発生する</td>
        <td>修正を展開済み<br>※ 一部のシナリオにおいて、同様の事象が再現することを確認しており、現在詳細の確認および調査を進めています。</td>
        <td></td>
        <td>文字入力ができなくなった際、引用の×アイコンを押下することで引用された文章がテキストとして残る事象も合わせて確認しております。</td>
    </tr>
    <tr>
        <td>参加者が自分のみの Teams 会議チャットでファイルを送信できない</td>
        <td>弊社開発部門にて、修正の展開が進められている状況。</td>
        <td>・会議チャットに他のユーザーを追加したうえで、ファイルの添付を行う。<br>・OneDrive や SharePoint 側で共有リンクを発行のうえ、共有リンクをチャットに貼る形で送信を行う。<br>・自分とのチャット((あなた)と表示されているチャット)を利用して、自分宛のメッセージやファイル送信を行う。</td>
        <td></td>
    </tr>
...
- 2025 年 8 月 22 日に、第 16 版を公開しました。
- 2025 年 11 月 12 日に、第 17 版を公開しました。
- 2025 年 12 月 2 日に、第 18 版を公開しました。
- 2026 年 2 月 10 日に、第 19 版を公開しました。
- 2026 年 2 月 24 日に、第 20 版を公開しました。
- 2026 年 5 月 11 日に、第 21 版を公開しました。